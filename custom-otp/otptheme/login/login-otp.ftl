            ...
            <#elseif section="form">
                <form id="kc-otp-login-form" class="${properties.kcFormClass!}" action="${url.loginAction}"
                    ...
                    <div class="${properties.kcFormGroupClass!}">
						...
						<div class="${properties.kcInputWrapperClass!}">
							<br/>
							<b>${msg("loginOtpDescription_part1")}</b>
							<br/>
							${msg("loginOtpDescription_part2")}
							<br/><br/>
							<b>${msg("loginOtpDescription_part3")}</b>
							<br/>
							${msg("loginOtpDescription_part4")}
							<br/><br/>
							<b>${msg("loginOtpDescription_part5")}</b>
							<br/>
							${msg("loginOtpDescription_part6")}
						</div>
                    </div>
